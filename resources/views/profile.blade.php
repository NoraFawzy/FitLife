...
<div class="container" style="margin-top: 10%;">
    <div class="row justify-content-center"> <!-- Use Bootstrap row to align cards -->
        ...
        @if (Auth::user()->role === 'user')
            <div class="col-lg-6 col-md-6 col-sm-12 mb-2"> <!-- Responsive column for the second card -->
                <div class="card" style="height: 300px;">
                    <div class="card-body text-center"> <!-- Center text in card body -->
                        ...
                        <p class="card-text"><strong>Description:</strong> <span id="plan-price">{{ $plan->desc }} </span></p> <!-- Bold Price -->
                        <p class="card-text"><strong>Price:</strong> <span id="plan-price">{{ $plan->price }} EGP</span></p> <!-- Bold Price -->
                        <p class="card-text"><strong>Start Date:</strong> <span id="start-date">{{ $user->updated_at }}</span></p> <!-- Bold Start Date -->
